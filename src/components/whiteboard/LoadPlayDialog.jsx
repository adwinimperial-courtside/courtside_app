          ...
          {loading ? (
            ...
            <ul className="divide-y divide-slate-100">
              {plays.map((p) => {
                ...
                return (
                  <li key={p.id} className="py-3 flex items-start gap-3 hover:bg-slate-50 -mx-2 px-2 rounded">
                    <button
                      onClick={() => onLoad(p)}
                    ...
                    {canDelete && (
                      <Button
                        ...
                        className={isConfirming ? "text-red-600" : "text-slate-400 hover:text-red-600"}
                      >
